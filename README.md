...
> 線上頁面  
> `https://jeremyabcd.github.io/ArtaleCalculate/`
...
1. 直接開啟 `index.html`或 'https://jeremyabcd.github.io/ArtaleCalculate/' 即可使用。
...
內建各武器的最大/最小係數，選取武器後會自動把係數帶入。

---

## 開發

- 只有單一檔案：`index.html`（含 HTML/CSS/JS）
- 可直接用 VS Code Live Server 或瀏覽器開啟測試
- PR / Issue 歡迎提出（Bug 報告、功能建議）
